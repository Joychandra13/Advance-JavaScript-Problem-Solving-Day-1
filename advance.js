...
//   ans: I am var, letVariable is not defined, constVariable is not defined
// varVariable is accessible and printed correctly, while letVariable and constVariable are not accessible outside their respective if block scopes,resulting in reference errors when trying to access them.



// 2. Write a function greet that takes two parameters, name and greeting.greeting should have a default value of "Hello". If only the name is providedthe function should return the greeting followed by the name. If both are provided,it should return the custom greeting followed by the name.
